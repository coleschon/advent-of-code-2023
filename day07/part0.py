...
class Hand:
    ...
    def __eq__(self, other): # == operator
        return self.type == other.type and self.type_cards == other.type_cards
    ...
    def __lt__(self, other): # < operator
        if self.type == other.type:
            ...
            # print(other)
            for i in range(0, 5):
                if self.type_cards[i] != other.type_cards[i]:
                    return self.type_cards[i] > other.type_cards[i]
    ...
    def __str__(self): # str() implementation
        return "{} {}".format(self.type, self.type_cards)
